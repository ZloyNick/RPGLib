...
/*
 *
 * THIS CLASS COPIED FROM pmmp Config (pocketmine\utils\Config)
 *
 * I MODIFIED JSON SAVE
 *
 */
...
namespace ZloyNick\data\config;
...
class Config
{
    ...
    /** @var int */
    private $jsonOptions = JSON_PRETTY_PRINT | JSON_BIGINT_AS_STRING | JSON_UNESCAPED_UNICODE;
    /** @var bool */
